...
require (
	...
	github.com/hyperledger/fabric-sdk-go v0.0.0-20221020141211-7af45cede6af // indirect
...
replace (
	github.com/IBM-Blockchain/fabric-operator => github.com/bestchains/fabric-operator v0.1.3-0.20230411015730-8d16a2502ccf
